...
class Response extends StructOptionalValues
{
    const schema = [
        "type" => '{{request_type}}',
        'tmp' => 'T::string()',
        'tmp1' => '{{entity_property}}',
        "data" => [
            "{{entity_property}}" => [
                'resource' => 'T::nullable(T::bool())',
            ]
        ],
    ];
    ...
    public function check($data = [], $haystack = null)
    {
        ...
        foreach ($haystack as $key => $value) {
            ...
            if (strpos($key, '{{') !== false) {
                ...
                $definition_type = constant('self::'. $definition_type_name);
