...
class Test implements TestInterface
{
    ...
    public function generate($model, $project, $definition, $entity): void
    {
        ...
        $request_schema_namespace = str_replace('@', '', $schema_hierarchy['hierarchy']['trident-vista']['{{entity_name}}']['Tests'][0]);
        $request_schema_definition = app()->make($request_schema_namespace);
        
        $response_schema_namespace = str_replace('@', '', $schema_hierarchy['hierarchy']['trident-vista']['{{entity_name}}']['Tests'][1]);
