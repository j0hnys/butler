...
class Test implements TestInterface
{
     ...
     * @return array
     */
    public function refresh($model, $project, $definition, $entity): void
    {
        if (SchemaHierarchy::class !== $definition['namespace']) {
            throw new \Exception("definition not recognized", 1);
        }
        ...
        $command  = 'cd '.str_replace('\\', '/', $project['root_folder']).' && ';
        $command .= 'php ';
        $command .= 'artisan trident:refresh:workflow_restful_crud_tests '.$entity['name'].' ';
        $command .= '--functionality_schema_path="'.$project['relative_schemas_folder'].'/'.$entity['name'].'/Tests/Resource/'.'Functionality.json'.'" ';
        $command .= '--request_schema_path="'.$project['relative_schemas_folder'].'/'.$entity['name'].'/Tests/Resource/'.'Request.json'.'" ';
        $command .= '--response_schema_path="'.$project['relative_schemas_folder'].'/'.$entity['name'].'/Tests/Resource/'.'Response.json'.'" ';
     ...
     * @return array
     */
    public function generateFeature($model, $project, $definition, $entity): void
    {
        if (SchemaHierarchy::class !== $definition['namespace']) {
            throw new \Exception("definition not recognized", 1);
        }
        ...
        //write json files to project directory
        //make folder
        $path = $project['root_folder'].'/'.$project['relative_schemas_folder'].'/'.$entity['name'].'/Tests/Features/'.$model['name'];
        if (!is_dir(dirname($path.'/.'))) {
            mkdir(dirname($path.'/.'), 0777, true);
        }
        file_put_contents($path.'/Functionality.json', json_encode($functionality_json, JSON_PRETTY_PRINT));
        ...
        $command  = 'cd '.str_replace('\\', '/', $project['root_folder']).' && ';
        $command .= 'php ';
        $command .= 'artisan trident:generate:workflow_restful_function_test '.$entity['name'].' '.$model['name'].' ';
        $command .= '--functionality_schema_path="'.$project['relative_schemas_folder'].'/'.$entity['name'].'/Tests/Features/'.$model['name'].'/Functionality.json'.'" ';
        $command .= '--request_schema_path="'.$project['relative_schemas_folder'].'/'.$entity['name'].'/Tests/Features/'.$model['name'].'/Request.json'.'" ';
        $command .= '--response_schema_path="'.$project['relative_schemas_folder'].'/'.$entity['name'].'/Tests/Features/'.$model['name'].'/Response.json'.'" ';
     ...
     * @return array
     */
    public function refreshFeature($model, $project, $definition, $entity): void
    {
        if (SchemaHierarchy::class !== $definition['namespace']) {
            throw new \Exception("definition not recognized", 1);
        }
        ...
        $command  = 'cd '.str_replace('\\', '/', $project['root_folder']).' && ';
        $command .= 'php ';
        $command .= 'artisan trident:refresh:workflow_restful_function_test '.$entity['name'].' '.$model['name'].' ';
        $command .= '--functionality_schema_path="'.$project['relative_schemas_folder'].'/'.$entity['name'].'/Tests/Features/'.$model['name'].'/Functionality.json'.'" ';
        $command .= '--request_schema_path="'.$project['relative_schemas_folder'].'/'.$entity['name'].'/Tests/Features/'.$model['name'].'/Request.json'.'" ';
        $command .= '--response_schema_path="'.$project['relative_schemas_folder'].'/'.$entity['name'].'/Tests/Features/'.$model['name'].'/Response.json'.'" ';
